...
const Card = ({ title, content, newAnswersCount, answersCount, onEdit, onDelete }) => {
  return (
    <div className="flex flex-col py-[12px] md:py-[16px] px-[18px] md:px-[24px] bg-white rounded-[8px] gap-[8px] shadow-[0px_0px_64px_0px_#D8D8D866]">
      ...
      {newAnswersCount > 0 ? (
        <p className="text-secondary-500 text-xl md:text-2xl font-nunito">+ {newAnswersCount} new answers</p>
      ) : (
