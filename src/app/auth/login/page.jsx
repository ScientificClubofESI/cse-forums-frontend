...
export const LogIn = () => {
  ...
  return (
    <div className="flex flex-col  sm:flex-row h-screen  sm:min-h-screen">
      ...
      <div className="bg-background-light  w-screen sm:w-1/2 h-full sm:h-screen px-8 sm:px-36  pt-4 pb-4 sm:pb-36 rounded-tr-none sm:rounded-tr-[80px]  ">

        <h1 className="text-primary-900 font-sans font-bold mb-12 sm:mb-16 text-2xl  sm:text-5xl ">Log In</h1>
        <form>

          <div className=" relative mb-10 sm:mb-16">
            <label className="block text-l font-serif font-bold text-primary-900 sm:text-2xl">Email</label>
            <input
              name="email"
          ...
          <div className="relative mb-4 sm:mb-16">
            <label className="block  font-serif font-bold text-primary-900  text-l sm:text-2xl">Password</label>
            <input
              name="password"
              placeholder="Enter your password"
              className="mt-1 w-full text-base ring-1 ring-neutral-300 p-2 text-neutral-900 font-serif focus:outline-none"
              type={showPassword ? "text" : "password"}
            />
            <a href="dfghj" className="mt-8 text-neutral-100"> Forget your password?</a>
          </div>
        ...
        <div className="flex justify-center items-center mt-10 mb-4">
          <p className="flex  block text-l font-serif text-neutral-500">Don't have an account?</p>
          <a href="dfghj" className="ml-2 text-secondary-500">Sign Up</a>
        </div>
      </div>
      <div className="w-screen sm:w-1/2  h-full sm:h-screen px-8 sm:px-36 pt-4 pb-2 sm:pb-36 bg-primary-900 rounded-tr-[40px] rounded-tl-[40px] sm:rounded-tr-none rounded-tl-[100px] ">
